...
c_mpq_set_si = rffi.llexternal(
    '__gmpq_set_si', [MPQ_PTR, rffi.LONG, rffi.ULONG], lltype.Void, compilation_info=info)
# c_mpq_set_ui = rffi.llexternal(
#     '__gmpq_set_ui', [MPQ_PTR, rffi.ULONG, rffi.ULONG], lltype.Void, compilation_info=info)
...
c_mpq_get_str = rffi.llexternal(
    '__gmpq_get_str', [rffi.CCHARP, rffi.INT, MPQ_PTR], rffi.CCHARP, compilation_info=info)
